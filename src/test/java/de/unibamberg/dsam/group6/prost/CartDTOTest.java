...
public class CartDTOTest {
    final static double PRICE1 = 256d;
    final static double PRICE2 = 512d;
    ...
    @BeforeEach
    void addTestToCart() {
        var a = this.bottlesRepository.save(
                Bottle.builder()
                        .name("bottleA")
                        .price(PRICE1)
                        .inStock(3)
        ...
        var b = this.bottlesRepository.save(
                Bottle.builder()
                        .name("bottleB")
                        .price(PRICE2)
                        .inStock(6)
    ...
    void multipleItems() {
        ...
        final var b = this.bottlesRepository.save(
                Bottle.builder()
                        .name("bottleC")
                        .price(price)
                        .inStock(9)
